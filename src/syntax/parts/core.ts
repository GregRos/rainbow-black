...
export default tmMap
    ...
    .set(["constant.language.null", "constant.language.undefined"], c.alt_object)
    ...
    .set(["storage.modifier.package", "storage.modifier.import", "storage.type.java"], c.keyword_1)
    .set(["punctuation.separator.comma", "storage.type.function.arrow"], [c.punctuation, ""])
